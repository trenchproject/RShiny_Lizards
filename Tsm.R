...
# "Lacerta agilis" "Sceloporus undulatus" too big 

org <- c("Sceloporus grammicus", "Sceloporus magister", "Sceloporus merriami", "Sceloporus undulatus", "Sceloporus variabilis", "Sceloporus woodi", "Phrynosoma douglassii")
